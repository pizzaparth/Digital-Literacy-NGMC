...
All tasks were completed using free, browser-based tools — no prior coding experience was required.

> 🔗 **GitHub Repository:** [https://github.com/pizzaparth/Digital-Literacy-NGMC](https://github.com/pizzaparth/Digital-Literacy-NGMC)
...
1. **Email to Professor** — requesting an extension on an assignment submission deadline
2. **Email to Internship Coordinator** — expressing interest in a summer internship opportunity

Both emails follow formal structure: subject line → greeting → body → sign-off.

**Part B – Social Media Checklist:**  
Created a Do's and Don'ts checklist with 5 rules on each side for responsible social media use as a college student.
...
Compiled 8+ specific, actionable prevention tips for college students in India, including:
- 2 tips specific to **UPI/financial safety**
- Reporting details: **National Cyber Crime Portal** ([cybercrime.gov.in](https://cybercrime.gov.in)) and **Helpline 1930**
...
- **LinkedIn / Kaggle** — Professional profiles (Task 2)
- **HackerRank** — Coding practice (Task 3)
- **Google Forms + Sheets** — Awareness quiz (Task 3)
- **Google Docs / MS Word** — Email drafts and report (Task 4)
- **cybercrime.gov.in** — Cybercrime research (Task 5)
